...
The key message is that since 0.9.6, you must ensure that your test framework ("Test::Unit":https://web.archive.org/web/20100208155315/http://ruby-doc.org/stdlib/libdoc/test/unit/rdoc/classes/Test/Unit.html or "MiniTest":http://blog.zenspider.com/minitest/) is loaded *before* "Mocha":http://gofreerange.com/mocha/docs/ is loaded, otherwise "Mocha":http://gofreerange.com/mocha/docs/ will not monkey-patch the test framework and calls to the Mocha API will result in "NoMethodError":http://www.ruby-doc.org/core/classes/NoMethodError.html.
