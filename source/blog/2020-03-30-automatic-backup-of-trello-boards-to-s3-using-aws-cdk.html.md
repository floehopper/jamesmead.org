...
<img style="display: block; margin-left: auto; margin-right: auto; width: 80%;" src="/images/aws-cdk-trello-backup.svg" alt="Automatic backup of Trello boards to S3 using the AWS CDK">
