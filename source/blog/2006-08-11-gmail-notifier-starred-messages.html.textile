...
I'm using the "GMail Notifier":http://mail.google.com/mail/help/notifier/ on OSX to notify me of new messages. I have a number of filters set up to automatically _star_ (!http://mail.google.com/mail/images/star_on_sm_2.gif!) potentially interesting posts and I wanted the Notifier to only tell me when I had new _starred_ messages.
