...
---
So I finally got round to releasing a "new version":http://rubyforge.org/frs/?group_id=1917&release_id=9184 of "Mocha":http://gofreerange.com/mocha/docs/. Much of the functionality has been available for some time if you've been using the Rails plugin based on subversion HEAD, but now you can get it in all in a gem (or other package). The most recent changes centre around allowing mocking of Object instance methods.
...
* Removed coupling to "Test::Unit":http://www.ruby-doc.org/stdlib/libdoc/test/unit/rdoc/classes/Test/Unit.html.
