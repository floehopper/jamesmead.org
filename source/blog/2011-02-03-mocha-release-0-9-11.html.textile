...
* Added a "URI parameter matcher":http://mocha.rubyforge.org/classes/Mocha/ParameterMatchers.html#M000025 that ignores the order of query parameters so that tests can be independent of undefined hash ordering (patch by "Paul Battley":http://po-ru.com/).
