...
* Allow "@Mocha::ParameterMatchers#includes@":http://gofreerange.com/mocha/docs/Mocha/ParameterMatchers.html#includes-instance_method to accept multiple items. Thanks to "Simão Mata":https://github.com/simao.
